...
Read `.claude/skills/performance/SKILL.md` for the decision tree.

Based on the target, load the appropriate reference:
- SwiftUI views → `references/swiftui-debugging.md`
- Profiling → `references/profiling-cli.md`
- Memory/launch/energy → `references/memory-energy.md`
